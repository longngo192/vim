...
_G.packer_plugins = {
  ...
  ["staline.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/nanonino/.local/share/nvim/site/pack/packer/opt/staline.nvim",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'staline.nvim', 'dashboard-nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
